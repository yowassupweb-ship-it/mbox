...
export const TOOL_CATALOG = [
  ...
  // SEO Wizard: четыре инструмента-заготовки — войдут в общий мастер SEO и будут доступны по отдельности.
  // Пока только карточки: planned — интерфейс показывает «в подготовке» и не предлагает запуск.
  {
    id: "wordstat-api",
    name: "Wordstat API",
    kind: "SEO · спрос",
