...
print('ERROR', errors);
print('WARN', warnings);
console.log(`Preflight: ${errors.length} errors, ${warnings.length} warnings, ${anchors.length} links, ${images.length} images, ${uniSenderBlocks.length} UniSender blocks, ${uniSenderAtoms.length} atoms.`);
