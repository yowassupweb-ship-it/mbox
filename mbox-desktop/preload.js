...
const desktopApi = {
  ...
  browser: {
    ...
    favicon: (url) => ipcRenderer.invoke("mbox-desktop:browser-favicon", url),
    ...
    openBookmarkFolderMenu: (name, x, y) => ipcRenderer.invoke("mbox-desktop:browser-bookmark-folder-menu", name, x, y),
    openBookmarkMenu: (key, bookmark, x, y) => ipcRenderer.invoke("mbox-desktop:browser-bookmark-popup", key, bookmark, x, y),
